...
object Html6Component extends BaseComponent {
  ...
  def apply[A, B, C, D, E, F](root: HTMLElement,
                              ...
                              rv5: Reactive[E],
                              rv6: Reactive[F],
                              formatter: (A, B, C, D, E, F) => String): NodesComponentController = {
    NodesComponentController { c =>
      val nodes = addHtml(c.parent.getOrElse(root))(m, formatter(rv1.v, rv2.v, rv3.v, rv4.v, rv5.v, rv6.v)).orDummyNode
      val wis = List(
  ...
  def apply[A, B, C, D, E, F](rv1: Reactive[A],
                              ...
                              rv5: Reactive[E],
                              rv6: Reactive[F])
                             (formatter: (A, B, C, D, E, F) => HTML): (HTMLElement, AddMethod) => NodesComponentController = {
